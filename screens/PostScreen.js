...
export default class StoryScreen extends Component {
  ...
  async initiateTTS (author, caption){
    ...
    this.setState({
      speakerColor:currentColor==="gray"?"red":"gray"
    })
    if(currentColor==="gray"){
      Speech.speak(`${author}by${caption}`);
    }else{
      Speech.stop()
    }
  }
          ...
          <View style={styles.storyContainer}>
            <ScrollView style={this.state.light_theme?styles.storyCardlight:styles.storyCard}>
              ...
              <View style={styles.dataContainer}>
                ...
                <TouchableOpacity onPress={()=>this.initiateTTS( this.props.route.params.post.author, this.props.route.params.post.caption)}>
                  <Ionicons
